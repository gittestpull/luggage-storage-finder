        ...
        <header className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-lg border-b border-gray-200/50">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex items-center justify-between h-16">
                    ...
                    <nav className="hidden md:flex items-center space-x-8">
                        ...
                        <div className="relative group">
                            ...
                            <div className="absolute left-1/2 -translate-x-1/2 top-full pt-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200">
                                <div className="bg-white rounded-xl shadow-xl border border-gray-100 py-2 w-40 overflow-hidden">
                                    <Link href="/news/hacker-typer" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 hover:text-green-600 transition-colors">
                                        💻 해커 화면
                                    </Link>
                                </div>
                            </div>
                    ...
                    <button onClick={() => setIsMenuOpen(!isMenuOpen)} className="md:hidden p-2 rounded-lg hover:bg-gray-100 relative z-50">
                            ...
                            <div className="flex flex-col h-full p-6">
                                ...
                                <div className="flex-1 overflow-y-auto min-h-0 py-2 space-y-6">
                                    ...
                                    <div className="space-y-3">
                                        <div className="text-sm font-semibold text-gray-500 uppercase tracking-wider pl-1">재미 & 놀거리</div>
                                        <div className="pl-4 border-l-2 border-gray-200 space-y-3">
                                            <Link
                                                href="/news/hacker-typer"
                                                onClick={() => setIsMenuOpen(false)}
                                                className="flex items-center text-lg font-medium text-gray-700 hover:text-green-600 transition-colors"
                                            >
                                                <span className="mr-3">💻</span> 해커 화면
                                            </Link>
                                        </div>
                                    </div>
